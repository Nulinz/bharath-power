                ...
                // ->whereNotNull('device_token') // make sure token exists
                    ...
                    if($activeCustomers){
                        ...
                        . "⚠️ Priority: {$req->priority}";
                          ...
                          //$title = "Hi {$activeCustomers->name}, Check Out Your New Enquiry ({$req->enqno})";
                       //   $title = "New Enquiry Assigned to {$activeCustomers->name} | Enquiry No: {$req->enqno}";
                      // $title = "Hello {$activeCustomers->name}, Please Review Your New Enquiry: {$req->enqno}";
                      //$title = "Hello {$activeCustomers->name}, Please Review Your New Enquiry: {$req->enqno}";
