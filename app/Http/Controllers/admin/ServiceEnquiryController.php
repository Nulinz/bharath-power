...
class ServiceEnquiryController extends Controller
{
    ...
    public function add_enquiry()
    {
        ...
        return view('admin.service.enquiry.add_enquiry', ['users' => $users, 'products' => $products, 'add_group' => $add_group]);
    }
    ...
    public function view_enquiry($id)
    {
        ...
        return view('admin.service.enquiry.enquiry_view', [
            'enquiry' => $view_eq,
            'task' => $task,
            'user_id' => $user_id,
            'users' => $users,
    ...
    public function enquiry_view($id)
    {
        ...
        return view('admin.service.enquiry.enquiry_view', compact('enquiry', 'tasks'));
    }
    ...
    public function showByLeadCycle($cycle)
    {
        ...
        return view('admin.service.enquiry.byCycle', [
            'cycle'     => $cycle,
    ...
    {
        DB::table('service_enquiry')->where('id', $id)->delete();

        return redirect()->route('admin.service.enquiry.enquiry_list')->with('message', 'Enquiry deleted successfully');
    }
}
