            ...
            <div class="row">
                                        ...
                                        {{-- <select class="form-select" name="enq_product" id="enq_product" required>
                                            ...
                                            @foreach ($products as $product)
                                                <option value="{{ $product->id }}"
                                                    {{ $enquiry->product_id == $product->id ? 'selected' : '' }}>
                                                    {{ $product->name }}
                                                </option>
                                            @endforeach
                                        </select> --}}
                                    ...
                                    @foreach ($task as $tak)
                                        <li class="timeline-item">
                                            <div class="tl-bg d-flex justify-content-between align-items-center p-2">
                                                ...
                                                <span
                                                    class="fw-normal text-sm text-white">{{ date('d-m-Y', strtotime($tak->created_at)) }}</span>
                                            </div>
                                            <div class="card-body p-3">
                                                <!-- task details -->
                ...
                <div class="col-12 col-xl-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('user.enquiry.submit_task') }}" method="POST" id="myForm"
