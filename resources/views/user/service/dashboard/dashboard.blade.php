            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-xl-3 d-flex">
                    <div class="card flex-fill" style="background-color: #ff015d">
                        <div class="card-body">
                            <a href="{{ route('user.service.enquiry.byCycle', ['cycle' => 'Enquiry Received']) }}" class="text-decoration-none">
                ...
                <div class="col-12 col-md-6 col-xl-3 d-flex">
                    <div class="card flex-fill" style="background-color: #fec000;">
                        <div class="card-body">
                            <a href="{{ route('user.service.enquiry.byCycle', ['cycle' => 'Initial Contact']) }}" class="text-decoration-none">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mb-2">
                ...
                <div class="col-12 col-md-6 col-xl-3 d-flex">
                    <div class="card flex-fill" style="background-color: #11a9b4">
                        <div class="card-body">
                            <a href="{{ route('user.service.enquiry.byCycle', ['cycle' => 'Requirement Gathering']) }}" class="text-decoration-none">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mb-2">
                ...
                <div class="col-12 col-md-6 col-xl-3 d-flex">
                    <div class="card flex-fill" style="background-color: #683ab7;">
                        <div class="card-body">
                            <a href="{{ route('user.service.enquiry.byCycle', ['cycle' => 'Product Selection']) }}" class="text-decoration-none">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mb-2">
                ...
                <div class="col-12 col-md-6 col-xl-3 d-flex">
                    <div class="card flex-fill" style="background-color: #ff9a00;">
                        <div class="card-body">
                            <a href="{{ route('user.service.enquiry.byCycle', ['cycle' => 'Quotation Preparation']) }}" class="text-decoration-none">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mb-2">
                ...
                <div class="col-12 col-md-6 col-xl-3 d-flex">
                    <div class="card flex-fill" style="background-color: #e7522d;">
                        <div class="card-body">
                            <a href="{{ route('user.service.enquiry.byCycle', ['cycle' => 'Quotation']) }}" class="text-decoration-none">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mb-2">
                ...
                <div class="col-12 col-md-6 col-xl-3 d-flex">
                    <div class="card flex-fill" style="background-color: #9f22b2 ;">
                        <div class="card-body">
                            <a href="{{ route('user.service.enquiry.byCycle', ['cycle' => 'Follow-up']) }}" class="text-decoration-none">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mb-2">
                ...
                <div class="col-12 col-md-6 col-xl-3 d-flex">
                    <div class="card flex-fill" style="background-color: #2dc60d;">
                        <div class="card-body">
                            <a href="{{ route('user.service.enquiry.byCycle', ['cycle' => 'Order confimred']) }}" class="text-decoration-none">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mb-2">
                ...
                <div class="col-12 col-md-6 col-xl-3 d-flex">
                    <div class="card flex-fill" style="background-color: #7a5548;">
                        <div class="card-body">
                            <a href="{{ route('user.service.enquiry.byCycle', ['cycle' => 'Material supplied partially']) }}" class="text-decoration-none">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mb-2">
                ...
                <div class="col-12 col-md-6 col-xl-3 d-flex">
                    <div class="card flex-fill" style="background-color: #3d50b6;">
                        <div class="card-body">
                            <a href="{{ route('user.service.enquiry.byCycle', ['cycle' => 'Material supplied final-full']) }}" class="text-decoration-none">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mb-2">
                ...
                <div class="col-12 col-md-6 col-xl-3 d-flex">
                    <div class="card flex-fill" style="background-color: #00988b;">
                        <div class="card-body">
                            <a href="{{ route('user.service.enquiry.byCycle', ['cycle' => 'Payment received partial']) }}" class="text-decoration-none">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mb-2">
                ...
                <div class="col-12 col-md-6 col-xl-3 d-flex">
                    <div class="card flex-fill" style="background-color: #0a813c;">
                        <div class="card-body">
                            <a href="{{ route('user.service.enquiry.byCycle', ['cycle' => 'Payment received final-full']) }}" class="text-decoration-none">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mb-2">
                ...
                <div class="col-12 col-md-6 col-xl-3 d-flex">
                    <div class="card flex-fill" style="background-color: #ed3799;">
                        <div class="card-body">
                            <a href="{{ route('user.service.enquiry.byCycle', ['cycle' => 'Final Decision']) }}" class="text-decoration-none">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mb-2">
                ...
                <div class="col-12 col-md-6 col-xl-3 d-flex">
                    <div class="card flex-fill" style="background-color: #e6151f">
                        <div class="card-body">
                            <a href="{{ route('user.service.enquiry.byCycle', ['cycle' => 'Cancelled']) }}" class="text-decoration-none">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mb-2">
                ...
                <div class="col-12 col-md-6 col-xl-3 d-flex">
                    <div class="card flex-fill" style="background-color: #04b5f3">
                        <div class="card-body">
                            <a href="{{ route('user.service.enquiry.byCycle', ['cycle' => 'Service Entry']) }}" class="text-decoration-none">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mb-2">
