                ...
                <div class="col-md-12 col-xl-12">
                    ...
                    <div class="card mb-3">
                        <div class="border-bottom p-3">
                            <form method="GET" action="{{ route('user.service.reports.index') }}" class="d-flex flex-wrap gap-2">
                                <div class="flex-fill">
                                ...
                                <div class="flex-fill d-flex align-self-end gap-2">
                                    ...
                                    <a href="{{ route('user.service.reports.index') }}" class="btn btn-secondary w-100"><i class="fa fa-undo"></i></a>
                                </div>
                            </form>
                        </div>
