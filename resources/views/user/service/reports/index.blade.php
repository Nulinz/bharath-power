                ...
                <div class="col-md-12 col-xl-12">
                    ...
                    <div class="card mb-3">
                        <div class="border-bottom p-3">
                            <form method="GET" action="{{ route('user.service.reports.index') }}" class="row g-3 align-items-end">
                                ...
                                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="enq_no" value="{{ request('enq_no') }}">
                                </div>
                                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                                    <div class="d-flex gap-2">
                                        ...
                                        <a href="{{ route('user.service.reports.index') }}" class="btn btn-secondary btn-sm w-100">
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            $('#datatables-reponsive').DataTable({
                ...
                buttons: [{
                        ...
                        title: 'Lead Management Service Report',
