 <nav id="sidebar" class="sidebar js-sidebar">
     <div class="sidebar-content js-simplebar">
         ...
         <ul class="sidebar-nav">
             ...
             <li class="sidebar-item {{ Route::is('user.service-dashboard') ? 'active' : '' }}">
                 <a class='sidebar-link fw-semibold' href='{{ route('user.service-dashboard') }}'>
                     <i class="align-middle" data-feather="grid"></i> <span class="fw-semibold align-middle">Dashboard</span>
                 </a>
             </li>

             <li class="sidebar-item {{ Route::is('user.service.enquiry.enquiry_list') ? 'active' : '' }}">
                 <a class='sidebar-link fw-semibold' href='{{ route('user.service.enquiry.enquiry_list') }}'>
                     <i class="align-middle" data-feather="file-text"></i> <span class="fw-semibold align-middle">Enquiry</span>
                 </a>
             </li>

             <li class="sidebar-item {{ Route::is('user.service.reports.index') ? 'active' : '' }}">
                 <a class='sidebar-link fw-semibold' href='{{ route('user.service.reports.index') }}'>
