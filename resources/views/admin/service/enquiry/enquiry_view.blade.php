            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6 col-xl-4">
                    ...
                    <div class="modal fade" id="editEnquiryModal" tabindex="-1" aria-labelledby="editEnquiryModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <form action="{{ route('admin.service.enquiry.update', $enquiry->id) }}" method="POST">
                                @csrf
                ...
                <div class="col-12 col-xl-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.service.enquiry.submit_task') }}" method="POST" id="myForm" enctype="multipart/form-data">
                                @csrf
