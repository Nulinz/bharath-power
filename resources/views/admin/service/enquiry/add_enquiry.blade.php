        ...
        <div class="container-fluid p-0">
            <div class="row mb-xl-3 mb-2">
                <div class="d-none d-sm-block col-auto">
                    <h3><strong>Add Service Enquiry</strong></h3>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.service.enquiry.store') }}" method="POST" id="myForm" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-3 inputs inter-det mb-3" style="display: none;">
                                    <label class="form-label fw-bold">Upload Quote</label>
                                    <input type="file" name="enq_quote" class="form-control">
                                </div>

                                <div class="col-md-3 inter-det mb-3" style="display: none;">
