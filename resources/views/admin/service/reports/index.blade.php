        ...
        <div class="container-fluid p-0">
            <div class="row mb-xl-3 mb-2">
                <div class="d-none d-sm-block col-auto">
                    <h3><strong>Lead Management Service Report</strong></h3>
                </div>
            </div>
                ...
                <div class="col-md-12 col-xl-12">
                    ...
                    <div class="card mb-3">
                        <div class="border-bottom p-3">
                            <form method="GET" action="{{ route('admin.service.reports.index') }}" class="d-flex flex-wrap gap-2">
                                <div class="flex-fill">
                                ...
                                <div class="d-flex flex-fill align-items-end gap-2">
                                    ...
                                    <a href="{{ route('admin.service.reports.index') }}" class="btn btn-secondary w-100"><i class="fa fa-undo"></i></a>
                                </div>
                            </form>
...
Enquiry No: ${enqNo}`;
            ...
            $('#datatables-reponsive').DataTable({
                ...
                buttons: [{
                        ...
                        className: 'btn btn-success',
                        text: 'Export to Excel',
                        title: 'Lead Management Service Report', // ✅ This sets the Excel title
                    ...
                    },
                    {
                        ...
                        className: 'btn btn-danger',
                        text: 'Export to PDF',
                        title: 'Lead Management Service Report', // ✅ This sets the PDF title
                        orientation: 'landscape',
                        pageSize: 'A4',
