        ...
        <div class="container-fluid p-0">
            <div class="row mb-xl-3 mb-2">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <a href="{{ route('admin.service.add_service_task') }}" class="btn btn-primary btn-md"><i class="fa fa-fw fa-plus align-middle"></i> Add Task</a>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select id="assignFilter" class="form-select">
                                        <option value="">All</option>
                                         @foreach ($users->pluck('name')->unique() as $assign)
                        ...
                        <div class="card-body">
                            <table id="datatables-reponsive" class="table-striped table" style="width:100%">
                                ...
                                <tbody class="">
                                   ...
                                   @foreach ($task_service as $task)
                                       <tr class="clickable-row" data-url="{{ route('admin.service.service_task_profile',['id' => $task->id]) }}">
