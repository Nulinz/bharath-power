<div class="card mb-3">
                                <div class="m-3 mb-0 pb-3 d-flex align-items-center justify-content-between border-bottom">
                                    ...
                                    <a class="btn btn-primary" href="{{ route('admin.settings.add_category') }}"><i
                                            class="align-middle fa fa-fw fa-plus"></i>Add Category</a>
                                </div>
                                <div class="card-body">
                                    <div class="">
                                    </div>
                                            ...
                                            @foreach ($category as $cat)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('admin.settings.edit_category', $cat->id) }}"><i
